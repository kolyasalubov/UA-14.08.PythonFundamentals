#you need to change in the Rect_pygame program so that the rectangle does not extend beyond the program
#потрібно змінити в програмі Rect_pygame, щоб прямокутник не виходив за межі програми
