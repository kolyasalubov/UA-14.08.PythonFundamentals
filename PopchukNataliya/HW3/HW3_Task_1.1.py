# Write Phyton's philosophy in string format
...
# The number of occurrences of the words "better" "never" and "is" in the given line
given_line = input ("Enter the given line of text:")
count_better = given_line.count("better")
count_never = given_line.count("never")
count_is = given_line.count("is")
print("Occurrences of 'better' in the given line:", count_better)
print ("Occurrences of 'never' in the given line:", count_never)
print ("Occurrences of 'is' in the given line:", count_is)
