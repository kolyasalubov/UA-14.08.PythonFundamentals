...
number_of_better = Zen.count('better')
number_of_never = Zen.count('never')
number_of_is = Zen.count('is')

print(f'Number of "better" = {number_of_better}')
print(f'Number of "never" = {number_of_never}')
print(f'Number of "is" = {number_of_is}')
